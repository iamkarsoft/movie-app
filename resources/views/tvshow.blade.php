    ...
    <div class="container mx-auto px-4 py-16 flex flex-col  md:flex-row">
     <div class="flex-none">
      ...
      <div class="md:ml-24 px-8">
          <h2 class=" text-4xl mt-2  hover:opacity-75 transition ease-in-out  hover:text-gray-300">{{$tv['name']}}</h2>
         ...
         <div class="mt-2">
            ...
            <ul>
             @foreach($tv['seasons'] as $season)
                <li>{{$season['name']}} - {{$season['episode_count']}}&nbsp;Episodes </li>
             @endforeach
            </ul>
         </div>
...
<div x-data="{isOpen : false }">
              ...
              <div class="mt-12">
                <button @click=" isOpen = true" class="inline-flex items-center bg-purple-500 text-gray-900 rounded font-semibold px-4 py-4 transition ease-in-out hover:bg-purple-600">
        ...
        <div class="bg-gray-900 rounded">
          ...
          <div class="modal-body px-8 py-8">
            <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
              <iframe src="https://youtube.com/embed/{{ $tv['videos']['results'][0]['key']}}" width="560" height="315" class="responsive-iframe absolute top-0 left-0 w-full h-full" frameborder="0" allow="autoplay; encrypted-media" style="border:0"></iframe>
            </div>
          </div>
        </div>
