    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto md:flex justify-between px-4 py-6">
            <ul class="md:flex items-center">
                <li class="ml-6 md:ml-16 font-extrabold my-4"><a href="{{route('movies')}}">Movie App</a></li>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4 hidden md:inline-block">
                    <a href="" >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="rounded-full w-8 h-8 mt-6">
