<div>
    ...
    @if($isOpen)
    <form  wire:submit.prevent="saveData" class="w-40 bg-white p-4 mt-4">

        <div class="my-4">
        <label for="season" class="block text-sm font-medium leading-6 text-gray-900">Season</label>
        <div class="mt-2">
        <input type="number" wire:model="season" class="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="0">
        </div>
        </div>
        ...
        <div class="my-4">
            ...
            <div class="mt-2">
            <input type="number" wire:model="episode" class="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="0">
            </div>
        </div>
