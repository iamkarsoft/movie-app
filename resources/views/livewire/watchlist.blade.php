<div>
    ...
    @if($movie_db)
      <button wire:click="$emit('movie_db')"  class="inline-flex items-center bg-purple-500 text-gray-900 rounded font-semibold px-4 py-4 transition ease-in-out hover:bg-purple-600">
                  ...
                  <span class="ml-2">Remove from Watch List</span>
      </button>
    @else
