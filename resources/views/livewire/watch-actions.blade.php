<div class="mx-4">
     <section class="text-white font-extrabold">
            ...
            <div class="w-40 flex-column border-slate-200 relative bg-purple-500 text-gray-900 rounded font-semibold px-4 py-4 transition ease-in-out hover:bg-purple-600" x-data="{ filter: false }">
    ...
    {{-- @elseif($movie_db['watch_type']==1) --}}
     <li wire:click="$emit('status','watch_action')"  class="inline-flex items-center w-full cursor-pointer">
        ...
        @endif
            <span class="ml-2" wire:model="watch_action">Watched</span>
      </li>
    {{-- @else --}}
