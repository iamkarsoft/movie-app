<div class="mx-4">
    ...
    @if($movie_db['watch_type']==0)
      <button wire:click="$emit('status')"  class="inline-flex items-center bg-purple-500 text-gray-900 rounded font-semibold px-4 py-4 transition ease-in-out hover:bg-purple-600">
